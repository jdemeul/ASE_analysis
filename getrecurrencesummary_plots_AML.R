...
airesultsfile <- "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/ASE_analysis/20180706_alloccurences_vst_AML.txt"
...
p1 <- p1 + geom_point(data = l2fcdf_melt[!l2fcdf_melt$sample_id %in% c("CD34"), ], alpha = .5, size = 2, stroke = 0)
...
p1
ggsave(filename = "20180706_l2fc_vst_AIrecurrenceGreaterThan1_AML.png", plot = p1, dpi = 300, width = 15, height = 6)
write.table(x = l2fcdf_melt, file = "20180706_l2fc_vst_AIrecurrenceGreaterThan1_table_AML.txt", sep = "\t", col.names = T, row.names = F, quote = F)
