...
airesultsfile <- "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/results/20181108_alloccurences_vst.txt"
...
resultfiles <- c(list.files(path = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/results/nomatch/", pattern = "*imbalance_expression_vst.txt", full.names = T, recursive = T),
                 list.files(path = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/results/cell_lines/", pattern = "*imbalance_expression_vst.txt", full.names = T, recursive = T))
...
p1 <- p1 + geom_point(data = l2fcdf_melt[l2fcdf_melt$sample_id %in% c("P12ICHIKAWA", "MOLT3", "JURKAT", "CCRF.CEM", "DU528", "PF382", "LOUCY", "KOPTK1", "DND41"), ], colour = "green", alpha = .5, size = 2, stroke = 0)
...
p1
ggsave(filename = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/results/20181108_l2fc_vst_AIrecurrenceGreaterThan2.png", plot = p1, dpi = 300, width = 15, height = 6)
write.table(x = l2fcdf_melt, file = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/results/20181108_l2fc_vst_AIrecurrenceGreaterThan2_table.txt", sep = "\t", col.names = T, row.names = F, quote = F)
