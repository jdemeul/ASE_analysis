...
combine_loci_nomatch <- function(countsdir, sample_id, genome = bsgenome_hg19) {
...
compute_pvals_nomatch <- function(toutdir, tsample, filtercutoff = 0.01, exclude_bad_snps = F) {
  ...
  genomecounts <- read_tsv(file = genomecountsfile, col_names = c("chr", "pos", "ref", "alt", "refCountGenome", "altCountGenome"), col_types = "ciccii")
