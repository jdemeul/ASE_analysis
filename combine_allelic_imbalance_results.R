...
write.table(x = aidf, file = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/ASE_analysis/20180525_allelic_imbalance_pooledsamples_vst.txt", sep = "\t", quote = F, row.names = F, col.names = T)
