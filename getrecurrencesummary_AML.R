...
airesults <- read.delim(file = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/ASE_analysis/20180706_allelic_imbalance_pooledsamples_vst_AML.txt",
                        sep = "\t", as.is = T)
...
write.table(x = aioccurrencespergene[, c("gene_name", "samples", "updown", "n_up", "n_down")],
            file = "/srv/shared/vanloo/home/jdemeul/projects/2016_mansour_ASE_T-ALL/ASE_analysis/20180706_alloccurences_vst_AML.txt", quote = F, sep = "\t", row.names = F)
